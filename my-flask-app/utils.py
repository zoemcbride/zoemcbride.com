...
def calculate_reading_time(text: str, average_words_per_minute: int = 225) -> int:
    """
    ...
    average_words_per_minute (int, optional): Average words read per minute. Default is 225
